...
IL_001f:
	{
		...
		NullCheck(L_6);
		VirtualActionInvoker1< BinaryWriter_tFB94D67EDFA3F6A34744A163BDABE287FDF2ED1E* >::Invoke(34 /* System.Void Facebook.WitAi.Lib.WitResponseNode::Serialize(System.IO.BinaryWriter) */, L_6, L_7);
		// for (int i = 0; i < m_List.Count; i++)
		int32_t L_8 = V_0;
...
IL_002f_1:
			{
				...
				NullCheck(L_12);
				VirtualActionInvoker1< BinaryWriter_tFB94D67EDFA3F6A34744A163BDABE287FDF2ED1E* >::Invoke(34 /* System.Void Facebook.WitAi.Lib.WitResponseNode::Serialize(System.IO.BinaryWriter) */, L_12, L_13);
			}
...
IL_009d:
	...
	}
	{
		...
		NullCheck(L_23);
		UnityEvent_tDC2C3548799DBC91D1E3F3DE60083A66F4751977* L_24 = L_23->___OnStartListening_17;
...
IL_0013:
	...
	}
	{
		...
		String_t* L_5 = __this->___clientAccessToken_6;
		bool L_6;
	...
	}
	{
		...
		V_2 = _stringLiteral54B7CB83ADA12ACDA6A9603F52C4337EFF74DE53;
		goto IL_004e;
	}
...
IL_0038:
	{
		...
		V_2 = _stringLiteral09D70245F3500CCD8237A0140F73164F286401D5;
		goto IL_004e;
	}
...
IL_0040:
	{
		...
		WitApplication_t63668A99EE80B05F17BCCDDAA4BF50A84A9A1E3C* L_8 = __this->___application_4;
		NullCheck(L_8);
		String_t* L_9 = L_8->___id_2;
		V_2 = L_9;
		goto IL_004e;
	}
...
IL_0062:
	{
		...
		NullCheck(L_12);
		WitResponseEvent_t5DEE4CFA5D09DD8C6293E1D41EF6A9ACBDD2CFDD* L_13 = L_12->___OnResponse_7;
